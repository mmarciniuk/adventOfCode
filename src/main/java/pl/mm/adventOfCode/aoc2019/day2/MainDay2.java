...
@Component
public class MainDay2 extends MainRunnerBase {
    ...
    public void run(String[] args) throws IOException {
        ...
        double totalFuelRequired = this.rocketEquationDay2.calculatedRequiredFuelForAllModuleAndReturnTotalFuelRequired(listOfModulesMass);
