...
public class ResultParameterTest {
    ...
    public Object[][] testDataProvider() {
        return new Object[][]{
                {new ResultParameter(Mode.POSITION_MODE, new int[]{1, 2, 3, 4}, 0), 2},
                {new ResultParameter(Mode.POSITION_MODE, new int[]{2, 2, 3, 4}, 0), 3},
                {new ResultParameter(Mode.IMMEDIATE_MODE, new int[]{1, 2, 3, 4}, 0), 0}
        };
    }
